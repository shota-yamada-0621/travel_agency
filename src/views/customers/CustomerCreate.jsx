...
const CustomerCreate = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const newId =
      local.length > 0 ? Math.max(...local.map((c) => c.id)) + 1 : 1001;
  ...
  return (
    ...
    >
      <div className="column is-6-tablet is-5-desktop is-4-widescreen">
        ...
        >
          <h2 className="title is-3 has-text-primary has-text-centered mb-5">
            新規顧客登録
          </h2>
          <form onSubmit={handleSubmit}>
            ...
            <div className="field mb-6">
              <label className="label is-large">画像アップロード</label>
            ...
            <div className="has-text-centered">
              <button
                className="button is-primary is-large is-rounded has-text-weight-bold px-6"
                type="submit"
              >
                <span className="icon">
