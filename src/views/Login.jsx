...
const Login = () => {
  ...
  return (
    <div className="container is-flex is-justify-content-center is-align-items-center" style={{ minHeight: "100vh", background: 'linear-gradient(135deg, #f8ffae 0%, #43c6ac 100%)' }}>
      <div className="box has-text-centered" style={{ minWidth: 380, boxShadow: '0 8px 32px 0 rgba(31, 38, 135, 0.2)', borderRadius: '2rem', background: 'rgba(255,255,255,0.95)' }}>
